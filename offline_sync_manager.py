...
class OfflineSyncManager:
    ...
    def start_background_worker(self):
        ...
        # Arrancar servidor HTTP interno de métricas
    ...
    def process_pending(self, max_ops: int = 50) -> int:
        ...
        try:
            ...
            cur.execute(
                ...
                (datetime.utcnow().isoformat(), max_ops),
            )
            rows = cur.fetchall()
    ...
    def _worker_loop(self):
        while not self._stop_event.is_set():
            ...
            time.sleep(self._processing_interval_sec)
        ...
        try:
            ...
            try:
                ...
                cur.execute(
                    ...
                    (cache_key, json.dumps(payload), datetime.utcnow().isoformat()),
                )
                conn.commit()
