...
async def api_gym_update(request: Request):
    ...
    try:
        ...
        try:
            ...
            try:
                from core.utils import read_gym_data as _read_gym_data  # type: ignore
    ...
    try:
        ...
        with db.get_connection_context() as conn:  # type: ignore
            ...
            try:
                ...
                from core.secure_config import config as secure_config
                try:
...
async def api_horario_waitlist_notify(horario_id: int, _=Depends(require_gestion_access)):
    ...
    try:
        ...
        try:
            from core.whatsapp_manager import WhatsAppManager  # type: ignore
