...
from utils import resource_path, get_serveo_subdomain, get_public_tunnel_enabled
import uuid
import socket
try:
    ...
    def setup_ui(self):
        ...
        try:
            ...
            if get_public_tunnel_enabled():
                ...
                web_icon_button.clicked.connect(lambda: QDesktopServices.openUrl(QUrl(f"https://{get_serveo_subdomain()}.serveo.net/")))
            else:
