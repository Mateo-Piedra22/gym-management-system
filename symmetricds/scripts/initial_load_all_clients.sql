-- Solicita carga inicial para todos los triggers configurados hacia cada tienda (store)
...
BEGIN
    ...
    -- Para cada tienda registrada, solicitar recarga por cada trigger configurado
    FOR n IN SELECT node_id FROM sym_node WHERE node_group_id = 'store' LOOP
        FOR tr IN
        ...
        LOOP
            IF NOT EXISTS (
                ...
                INSERT INTO sym_table_reload_request (
                    ...
                    n.node_id, server_id, tr.trigger_id, 'corp_to_store',
